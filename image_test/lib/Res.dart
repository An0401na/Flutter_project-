...
List<ResImageDir> resImageDirFromJson(String str) => List<ResImageDir>.from(
    json.decode(str).map((x) => ResImageDir.fromJson(x)));

String resImageDirToJson(List<ResImageDir> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
